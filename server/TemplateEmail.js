...
const email_template = async ({ name, paternSurname, maternSurname}) => {          
    ...
    return (
   `<table align="center" width="100%" role="presentation" cellspacing="0" cellpadding="0" border="0" style="max-width: 680px; width: 100%; margin: 0px auto;">
   <tbody>
      <tr style="width: 100%;">
       <td>
      ...
      <tr>
        <td width="100%">
          ...
          <h2 style='text-align: center;'>GRACIAS POR FORMAR PARTE DE, <span style="color:#E94568;font-weight:bold;">ITM 2024</span>, CONSTRUYAMOS LA INDUSTRIA DEL MAÑANA</h2>                    
        </td>      
      </tr> 
      <tr>
        <td>
          ...
          <div style="text-align:center;padding:20px;margin-top:25px;">
            <a style="background-color: #0E2242;color:white;padding:20px;border-radius:20px;margin:20px;text-decoration:none;" 
