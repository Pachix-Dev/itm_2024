...
export class RegisterModel {
  ...
  static async get_all_users_to_send() {
    const emails = [
      "gjasso@dintux.com",
      "Clientes@t-efficiency.com",
      "Giovanna.ortiz@t-efficiency.com",
      "iwmventas@hotmail.com",
      "Isabelr@iwmmanufacturing.com",
      "iwmventas5@gmail.com",
      "iwmmanufacturing.fac@gmail.com",
      "admin@grunconstructora.com",
      "erick.zuniga@arservicios.com.mx",
      "m.perez@proledservice.com",
      "fernando.xterminio@gmail.com",
      "gerencia@x-terminio.com",
      "iwmsoniafv@gmail.com",
      "antonio.lara@nomlex.mx",
      "cviridiana.castro@gmail.com",
      "abraham.fernandez@nmrk.com",
      "Malecon276.michelin@gmail.com",
      "arturo.cruz@cahleg.com",
      "adrian.bautista@iado.com.mx",
      "saludlaboralkxk@outlook.com",
      "johanna.estrada1013@gmail.com",
      "distribuidorapolitodo@gmail.com",
      "cgarci.m3@gmail.com",
      "lem.miriamalmanza@gmail.com",
      "minerva_canul@tadbikmexico.com",
      "automotriz@canacintra-leon.org.mx",
      "dgraficocanaleon@gmail.com",
      "oscar.fernandez@arservicios.com.mx",
      "direccion@canacintra-leon.org.mx",
      "Maria.jasso@azis.com.mx",
      "compras@ferreheto.com",
      "ventas@ferreheto.com",
      "taller.rema.1@gmail.com",
      "ezapien@ppstech.mx",
      "german.martinez@gebesa.com",
      "maximusarticulosdepiel@gmail.com",
      "proyectoscanacintrainnova@gmail.com",
      "Miguel.rivera@mexatech.com.mx",
      "contacto@akadiok.com",
      "sagaelias13@hotmail.com",
      "tradicobanquetesyproducciones@gmail.com",
      "berny7422ms@gmail.com",
      "betosalcedocalderon@gmail.com",
      "Creandofinanzaspoderosas@gmail.com"
    ];
    const connection = await mysql.createConnection(config);
