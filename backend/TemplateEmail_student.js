        ...
        <tr>
          <td colspan="2" >
            <h2 style="text-align: center;margin:0;font-weight:bold;text-transform: uppercase;margin-top: 20px;">
              BIENVENIDO ESTUDIANTE, ${name} ${paternSurname} ${maternSurname}. <BR /> TE RECORDAMOS QUE TU ACCESO GRATUITO ES VÁLIDO SOLO EL DÍA JUEVES 13 DE NOVIEMBRE A PARTIR DE LAS 15:00 HRS.
            </h2>
            ...
            <div style="text-align:center;padding:20px;margin-top:25px;">
              ...
              <p style="margin-top:40px;margin-bottom: 40px;">
                Te esperamos en la sexta edición de <strong>INDUSTRIAL TRANSFORMATION MEXICO  13 de noviembre, CENTRO BANAMEX, CDMX.</strong>
              </p>
              <div style="background: #E42128;color:white;border-radius: 20px;padding:20px;">               
               <p><strong>HORARIOS:</strong></p>
               <p>Jueves 15:00 am – 17:00 hrs
              </p>               
              </div>
            </div>               
