...
export function CounterDown({ dias, horas, minutos, segundos }) {
  ...
  return (
    <div className='text-white bg-transparent bg-opacity-50 backdrop-blur-md flex text-center md:grid md:text-left lg:flex lg:text-center justify-center gap-6 text-md md:text-3xl font-semibold py-5 px-5 md:px-8 lg:px-2 border rounded-lg'>
      <div>
